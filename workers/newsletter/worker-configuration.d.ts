/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=workers/newsletter/wrangler.jsonc --strict-vars=false workers/newsletter/worker-configuration.d.ts` (hash: e0cd6d6d8ac5c6c5ada4314bf5355ef1)
// Runtime types generated with workerd@1.20260811.1 2026-09-05 nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	NEWSLETTER_ENABLED: string;
	RESEND_DOMAIN_ID: string;
	RESEND_FROM_EMAIL: string;
	NEWSLETTER_SERVICE_TOKEN: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEWSLETTER_ENABLED" | "RESEND_DOMAIN_ID" | "RESEND_FROM_EMAIL" | "NEWSLETTER_SERVICE_TOKEN" | "NEWSLETTER_TOKEN_SECRET" | "RESEND_API_KEY">> {}
}
