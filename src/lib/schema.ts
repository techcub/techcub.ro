...
/**
 * Create Person schema for the business owner
 */
export function createPersonSchema(): WithContext<Person> {
  return {
    ...
    jobTitle: businessConfig.professionalTitle,
    url: siteConfig.url,
...
export function createProfessionalServiceSchema(): WithContext<LocalBusiness> {
  return {
    ...
    ...(siteConfig.address?.city
      ...
      : {}),
    areaServed: [
      { '@type': 'City', name: businessConfig.serviceArea },
      { '@type': 'Country', name: 'România' },
    ],
    description: businessConfig.description,
    knowsAbout: [...businessConfig.services],
    sameAs: siteConfig.socialLinks,
  };
}
...
export function createOrganizationSchema(): WithContext<Organization> {
  ...
  return {
    ...
    '@type': 'Organization',
    name: siteConfig.name,
    legalName: businessConfig.legal.name,
    url: siteConfig.url,
