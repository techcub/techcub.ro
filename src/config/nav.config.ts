...
export const footerNavItems: NavItem[] = [
  ...
  { label: 'About', href: '/about', order: 4, labelKey: 'nav.items.about' },
  { label: 'Contact', href: '/contact', order: 5, labelKey: 'nav.items.contact' },
  { label: 'GitHub', href: businessConfig.socialLinks[0], order: 6, external: true },
];
...
export const legalLinks: LegalLink[] = [
  {
    ...
    locales: { en: { label: 'Privacy', href: '/privacy' } },
  },
  {
    label: 'Termeni și condiții',
    href: '/termeni-si-conditii',
    locales: { en: { label: 'Terms and conditions', href: '/terms-and-conditions' } },
  },
];
...
export const footerLinkGroups: FooterLinkGroupConfig[] = [
  {
    ...
    title: 'Got questions?',
    links: [
      { label: 'Email', href: `mailto:${businessConfig.email}` },
      { label: 'Telefon', href: `tel:${businessConfig.phone}` },
      { label: 'WhatsApp', href: businessConfig.whatsapp, external: true },
    ],
  },
];
