  ...
  articleFeatures?: {
    ...
    comments?: {
      ...
      giscus?: {
         ...
         * current locale. Set a specific Giscus language code when needed.
         * to override.
         */
        lang?: string;
      };
...
const siteConfig: SiteConfig = {
  ...
  footerNote: businessConfig.availability,
  ...
  author: businessConfig.ownerName,
  email: businessConfig.email,
  phone: businessConfig.phone,
  address: {
    street: '',
    city: businessConfig.serviceArea,
    state: '',
    zip: '',
    country: 'România',
  },
